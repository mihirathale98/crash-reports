...
def run(agency, month, year):
    ...
    print(os.path.exists(f"reddit_posts_{timestamp}.csv"))
    if os.path.exists(f"report_{agency.replace(' ', '_').lower()}_{timestamp}.md"):
        ...
        if not os.path.exists(f"reddit_posts_{timestamp}.csv") and not os.path.exists(f"reddit_comments_{timestamp}.csv"):
            ...
            posts_df = pd.read_csv(f"reddit_posts_{timestamp}.csv")
            comments_df = pd.read_csv(f"reddit_comments_{timestamp}.csv")
